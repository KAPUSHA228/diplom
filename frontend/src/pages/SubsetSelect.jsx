      ...
      <div style={{ marginBottom: 12 }}>
        ...
        <div className="strategy-grid" style={{ marginTop: 8 }}>
          {MODES.map((m) => (
            <label
              key={m.value}
              className={`strategy-option ${mode === m.value ? "selected" : ""}`}
            >
              <input
                type="radio"
                name="subset-mode"
        ...
        <div style={{ marginBottom: 12 }}>
          <label>
            ...
            <input
              type="range"
              min="5"
              max={Math.min(activeData?.length || 500, 500)}
              step="5"
              value={nSamples}
        ...
        <div style={{ marginBottom: 12 }}>
          <label>
            ...
            <input
              ...
              placeholder="avg_grade > 4 and risk_flag == 0"
              style={{
                width: "100%",
                marginTop: 4,
                padding: 8,
          ...
          <label>
            ...
            {availableClusters.length > 0 ? (
              ...
              <span className="muted" style={{ fontSize: 13 }}>
                {" "}
                (Сначала запустите анализ на главной)
              </span>
            )}
          </label>
        </div>
        ...
        <div style={{ marginTop: 12 }}>
          ...
          {result.data?.length > 0 && (
            <div className="table-wrap">
              ...
              {result.count > 20 && (
                <p className="muted">Показано 20 из {result.count}</p>
              )}
            </div>
          )}
        </div>
